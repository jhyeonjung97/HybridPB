...
python ../../HybridPourbaix.py --legend-out --Umin -2 --Umax 2 --pHmin -2 --pHmax 16 \
...
# hybrid (bulk)
mv no3rr/* .
python ../../HybridPourbaix.py --legend-out --Umin -2 --Umax 2 --pHmin -2 --pHmax 16 --hybrid --png \
--colors-bulk white darkgray gainsboro white darkgray

# hybrid
python ../../HybridPourbaix.py --legend-out --Umin -2 --Umax 2 --pHmin -2 --pHmax 16 --hybrid --no-bulk \
