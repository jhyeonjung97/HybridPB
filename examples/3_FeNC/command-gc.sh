...
mv vac/vac*.json .
rm -r vac/
python ../../HybridPourbaix.py --legend-out --OER --hybrid --suffix Fe2O3 \
--show-transitions --no-bulk --figx 4 --figy 4 --Umin -1.0 --Umax 2.5 \
--colors-bulk white gainsboro darkgray dimgray white gainsboro dimgray gray \
--colors-2d '#73ADD1' '#B9E0ED' '#F0F9DB'

python ../../HybridPourbaix.py --legend-out --OER --hybrid --thermo-data ./thermodynamic_data.jsonc \
--show-transitions --no-bulk --figx 4 --figy 4 --Umin -1.0 --Umax 2.5 \
--colors-bulk white gainsboro gainsboro white darkgray dimgray gray \
--colors-2d '#73ADD1' '#B9E0ED' '#F0F9DB'

# gc + hybrid
python ../../HybridPourbaix.py --legend-out --OER --gc --hybrid --suffix Fe2O3 \
--show-transitions --no-bulk --figx 4 --figy 4 --Umin -1.0 --Umax 2.5 \
--colors-bulk white gainsboro darkgray gainsboro white dimgray \
--colors-2d '#73ADD1' '#B9E0ED' '#F0F9DB'

python ../../HybridPourbaix.py --legend-out --OER --gc --hybrid --thermo-data ./thermodynamic_data.jsonc \
--show-transitions --no-bulk --figx 4 --figy 4 --Umin -1.0 --Umax 2.5 \
